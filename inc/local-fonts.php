...
function nuocda_168_get_local_fonts_css() {
	...
	// optional: giảm CLS. Trang chủ: chỉ Vietnamese (~nhỏ) — latin dùng system (tránh chuỗi +37/+47KB).
	$css  = "@font-face{font-family:'Inter';font-style:normal;font-weight:400 800;font-display:optional;src:url({$base}/inter/inter-400-vietnamese.woff2) format('woff2');unicode-range:{$vi_range}}";
	$css .= "@font-face{font-family:'Montserrat';font-style:normal;font-weight:400 800;font-display:optional;src:url({$base}/montserrat/montserrat-400-vietnamese.woff2) format('woff2');unicode-range:{$vi_range}}";

	if ( ! $is_home ) {
		$css .= "@font-face{font-family:'Inter';font-style:normal;font-weight:400 800;font-display:optional;src:url({$base}/inter/inter-400-latin.woff2) format('woff2');unicode-range:{$latin}}";
		$css .= "@font-face{font-family:'Montserrat';font-style:normal;font-weight:400 800;font-display:optional;src:url({$base}/montserrat/montserrat-400-latin.woff2) format('woff2');unicode-range:{$latin}}";
	}
...
function nuocda_168_preload_local_fonts() {
	...
	// Trang chủ: chỉ Inter VI (body). H1 dùng system font — không preload Montserrat/latin.
