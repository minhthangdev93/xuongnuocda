...
if ( $related_products ) :
	...
	<section class="related products nuocda-related-products">

		<?php
		$heading = apply_filters( 'woocommerce_product_related_products_heading', __( 'Sản phẩm tương tự', 'oceanwp' ) );

		if ( $heading ) :
			?>
			<h2 class="nuocda-related-products__heading"><?php echo esc_html( $heading ); ?></h2>
		<?php endif; ?>
		<?php
